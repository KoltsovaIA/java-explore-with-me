...
public class StatClient {
    ...
    @Autowired
    public StatClient(@Value("${statistic.server.address}") String serverUrl, RestTemplateBuilder builder) {
        rest = builder
    ...
    public ResponseEntity<Object> postStat(IncomingDto incomingDto) {
        return post("/hit", incomingDto);
    }
